...
#ifndef DM_DISPLAY_2_H
#define	DM_DISPLAY_2_H
...
Example
   while ( false == DM2_TakeInitDisplayStep() )
...
Example
   while (false == DM2_TakeDisplayUpdateStep())
   {} // note this example is for non-event-driven code
****************************************************************************/
...
Example
   DM2_AddChar2Display('A');
****************************************************************************/
void DM2_AddChar2DisplayBuffer( unsigned char Char2Display);

void DM2_AddRow2DisplayBuffer( uint16_t data);
...
Example
   DM2_PutDataInBufferRow(0x00000001, 0);
****************************************************************************/
