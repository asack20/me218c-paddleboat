...
typedef enum { 
    SPI_CLK_HI = 0, // this is backwards from def in SPI doc
    SPI_CLK_LO = 1 
} SPI_Clock_t;

typedef enum { // this is backwards from def in SPI doc
    SPI_FIRST_EDGE = 0, 
    SPI_SECOND_EDGE = 1 
} SPI_ActiveEdge_t;
